...
public class UploadService {
    ...
    private void createMissedDirectories( @NonNull RestClient restClient, @NonNull String uploadPath ) {
        ...
        List<String> paths = List.of( uploadPath.split( "/" ) );
    ...
    private String getUploadPath( @NonNull File file ) {
        ...
        List<String> paths = new ArrayList<>( List.of( configuration.getDiskPath().split( "/" ) ) );
        paths.addAll( List.of( fileYearMonth, fileYearMonthDay, file.getName() ) );
        return paths.stream()
                .map( String :: trim )
